package lti.com.training.servlet;
...
public class CaptchaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String str="abcdefghyoiendomgspwbqskvtekodhbpjdjclldsueytwbvfkvgghrirbwofhfngolehdkmfvnjvgk";
		String captcha=" ";
		
		//piking up 5 random characters
		for(int i=0; i<5 ;i++) {
